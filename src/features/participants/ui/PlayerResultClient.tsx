  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4 w-full max-w-sm mb-8">
        <ScoreCard label="획득 점수" value={`+${result.points}`} highlight={result.correct} />
        <ScoreCard label="총 점수" value={String(result.totalPoints)} highlight={false} />
        <ScoreCard label="현재 순위" value={`${result.rank}위`} highlight={false} />
      </div>
